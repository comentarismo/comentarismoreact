...
class Article extends Component {
    ...
    render () {
        ...
        try {
            if (this.props.article && this.props.article.date &&
                this.props.article.totalComments) {
                var dt = moment(this.props.article.date)
                var today = moment()
                
                var diffInDays = today.diff(dt, 'days') // x days
                if (diffInDays > 0) {
                    commentsavgperday = parseFloat(
                        this.props.article.totalComments) /
            ...
            return (<div>
                ...
                <div style={{
                    ...
                    <div id='content' dangerouslySetInnerHTML={{
                        __html: (100 - (100 * (targetText.length /
                            (article.title.length +
                                article.resume.length)))).toFixed(2),
                    }}/>
                </div>
            </div>)
        }
        ...
        return (
            <div>
                ...
                <Grid fluid={false} className="center-sm col-xs-12"
                            ...
                            <CardHeader style={{
                                ...
                                paddingBottom: '0px',
                                        ...
                                        title={<span style={{
                                            ...
                                            : ' '}</span>}
                                        avatar={<a
                                            href={`/news/operator/${article.operator}`}><img
                                            style={{
                                                height: '24px',
                                                width: '24px',
                                                marginTop: '8px',
                            ...
                            <CardTitle style={{
                                ...
                                paddingBottom: '0px',
                                       ...
                                       title={<a target="_blank"
                                           ...
                                           dangerouslySetInnerHTML={{__html: article.title}}/></a>}
                                       titleStyle={{}}
