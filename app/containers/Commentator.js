                                            ...
                                            <div className="profile-divStats">
                                                <ul className="profile-commentsfollowfollowers">
                                                    <li className="profile-commentsfollowfollowersLi">
                                                        ...
                                                        <span className="profile-StatValue">{ commentator.minDate }</span>
                                                    </li>
                                                </ul>
                                            </div>
                                            <div className="profile-divStats">
                                                <ul className="profile-commentsfollowfollowers">
                                                    <li className="profile-commentsfollowfollowersLi">
                                                        ...
                                                        <span className="profile-StatValue">{ commentator.maxDate }</span>
                                                    </li>
                                                </ul>
                                            </div>
                                            <div className="profile-divStats">
                                    ...
                                    <div className="profile-divStats">
                                        <ul className="profile-commentsfollowfollowers">
                                            <li className="profile-commentsfollowfollowersLi">
                                                ...
                                                <span className="profile-StatValue">{ commentator.totalComments }</span>
