...
class CommentatorsProductContainer extends Component {
    ...
    handlePageChange(skip, limit) {
        ...
        getAllByIndexFilterSkipLimit("commentator_product", index, value, skip, limit, "totalComments", function (err, res) {
            // Do something
                                            ...
                                            this.state.articles.map((q)=> {
                                                return (
                                                    <div className="col-lg-3 col-md-3 col-sm-5 col-xs-10">
                                                        <a href={`/commentator_product/${q.id}`} className='thumbnail article'>
...
export { CommentatorsProductContainer }
export default connect(mapStateToProps, {loadCommentators})(CommentatorsProductContainer)
