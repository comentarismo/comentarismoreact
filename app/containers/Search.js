			...
			searcbox = <SearchkitProvider searchkit={searchkit}>
				<Layout>
					<SearchBox style={style}
					           ...
					           searchOnChange={true}
					           prefixQueryFields={["nick", "genre", "comment", "operator", "title", "language"]}/>
					<LayoutBody>
						<SideBar>
							<RefinementListFilter
								id="languages"
						...
						<LayoutResults>
							...
							<Hits mod="sk-hits-list" hitsPerPage={5} listComponent={SearchNewsCommentsList}
							      highlightFields={["comment", "nick", "title"]}
							      sourceFilter={["title", "comment", "nick", "operator", "titleurlize", "sentiment"]}/>
							<NoHits/>
							<Pagination showNumbers={true}/>
