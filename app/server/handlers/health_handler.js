...
module.exports = function (app, REDIS_CONNECTION, RETHINKDB_CONNECTION) {
    ...
    app.get('/health', function (req, res) {
        ...
        logger.debug('****** Will test RethinkDB connection')
        const rethinkdbStatus = RETHINKDB_CONNECTION.getPoolMaster()._healthy
        
        res.send({redis_healthy: redisStatus, rethinkdb_healthy: rethinkdbStatus})
    })
